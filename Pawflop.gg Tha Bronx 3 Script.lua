...
if LPH_OBFUSCATED == nil then
    ...
    LRM_ScriptName = "Talaa.lol"
    LRM_TotalExecutions = 0
    LRM_SecondsLeft = math.huge
    LRM_UserNote = "Developer";
end;

local Game_Name = (game.PlaceId == 4991214437 and "Town") or (game.PlaceId == 18642421777 and "Tha Bronx 3") or (game.PlaceId == 16472538603 and "Tha Bronx 3") or (game.PlaceId == 13643807539 and "South Talaa") or (game.PlaceId == 93612682780562 and "South Talaa") or (game.PlaceId == 14413475235 and "South Talaa") or (game.PlaceId == 104715542330896 and "BlockSpin") or (game.PlaceId == 71600459831333 and "Street Life") or "Universal" or game.PlaceId == 13643807539
...
local Services = setmetatable({}, {
    __index = LPH_NO_VIRTUALIZE(function(self, service, key)
        if Solara and (service == "VirtualInputManager") and (Game_Name == "Tha Bronx 3") then
...
if Game_Name == "South Talaa" and not Solara then
...
if script_key then
    writefile("TalaaLol_Key.txt", script_key)
end
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("Talaa.lol | Security : You are running another script, please disable it and execute again")
    end
end
...
local Config = {
    ...
    ["Game"] = {
        ["Ray_Systems"] = (Game_Name == "Road To Riches" and {"Raycast"} or Game_Name == "BlockSpin" and {"Raycast"} or Game_Name == "Town" and {"Raycast"} or Game_Name == "Universal" and {"Raycast","FindPartOnRay","FindPartOnRayWithWhitelist"} or Game_Name == "Tha Bronx 3" and {"FindPartOnRay"}  or Game_Name == "South Talaa" and {"Raycast"} or Game_Name == "Street Life" and {"Raycast"} or Game_Name == "Criminality" and {"Raycast"}) or {};
        ["Wall_Bang_Possible"] = ((Game_Name == "Universal" or Game_Name == "Criminality" or Game_Name == "South Talaa" or Game_Name == "Tha Bronx 3" or Game_Name == "Street Life"));
    };
...
--[[if not Solara and Game_Name == "Tha Bronx 3" then
    local DTC;
...
getgenv().library = {
    directory = "Talaa.lol_remastered",
    folders = {
        "/fonts",
        "/configs",
        "/assets"
...
if not Solara then
    ...
    if Game_Name == "Universal" or Game_Name == "Road To Riches" or Game_Name == "Street Life" or Game_Name == "Tha Bronx 3" or Game_Name == "Town" and not Solara then
        local DTC;
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "Tha Bronx 3" then
            RunService:BindToRenderStep("MiscSettings", 1000 , LPH_NO_VIRTUALIZE(function(Delta)
                ...
                if not (Game_Name == "South Talaa") and not (Game_Name == "Road To Riches") then
                ...
                if Config.TheTalaa.PlayerUtilities.SpectatePlayer then
                    Set_Spectate = false
                    local Subject = Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) and Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character and Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid")

                    if not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid") then
            ...
            RunService:BindToRenderStep("MiscSettings", 1000 , LPH_NO_VIRTUALIZE(function()
                ...
                if Config.South_Talaa.PlayerUtilities.SpectatePlayer then
                    Set_Spectate = false
                    local Subject = Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer) and Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character and Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid")

                    if not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid") then
                        Subject = LocalPlayer.Character.Humanoid
                    end
                ...
                if Game_Name == "South Talaa" then
                    if LocalPlayer.Character.Head:FindFirstChild("RankTag") then
                        --if not getgenv().Window then return end

                        LocalPlayer.Character.Head:FindFirstChild("RankTag").MainFrame.NameLabel.Visible = not Config.South_Talaa.LocalPlayer_Config.HideName
                    end
                end

                if Game_Name == "South Talaa" and Solara then
                    return
                end

                if Game_Name == "South Talaa" and Config.South_Talaa.LocalPlayer_Config.InfiniteStamina and not Solara then
        ...
        GetClosestPlayerToMouseAimbot = LPH_NO_VIRTUALIZE(function()
            ...
            if library.priority[1] then
                for Index, Value in Plrs do
                    ...
                    if (Value.Character and Value.Character:FindFirstChild(Config.Aimlock.TargetPart) and Value.Character:FindFirstChild("Humanoid") and Value.Character:FindFirstChild("Humanoid").Health > (Game_Name == "South Talaa" and 4 or 0)) then
        ...
        GetClosestPlayerToMouseSilent = LPH_NO_VIRTUALIZE(function()
            ...
            if library.priority[1] then
                for Index, Value in Plrs do
                    ...
                    if not table.find(library.priority, Value.Name) then continue end;
                    if table.find(library.whitelist, Value.Name) then continue end;
                    if (Value.Character and FindFirstChild(Value.Character, "HumanoidRootPart") and FindFirstChild(Value.Character,"Humanoid") and FindFirstChild(Value.Character,"Humanoid").Health > (Game_Name == "South Talaa" and 4 or 0)) then
                        if FindFirstChildOfClass(Value.Character, "ForceField") then continue end
                        if FindFirstChild(Value.Character, "Torso") and FindFirstChild(Value.Character, "Torso").Material == Enum.Material.ForceField then continue end
                        if Value.Character.Parent == nil then continue end
            ...
            if Method == "Raycast" and table.find(Config.Game.Ray_Systems, "Raycast") then
                ...
                if Config.Silent.Enabled then
                    if Config.Silent.Targetting then
                        ...
                        if not Config.Silent.WallBang and Game_Name == "South Talaa" then
                            local RaycastParams = RaycastParams.new()
        ...
        for Index, Value in Players:GetPlayers() do
            if Value == LocalPlayer then continue end;
            if Game_Name == "South Talaa" then continue end
        ...
        Players.PlayerAdded:Connect(function(Value)
            if Game_Name == "South Talaa" then return end
        ...
        if Game_Name == "South Talaa" then
            if not Solara then
                ...
                local ModWeapon = LPH_JIT_MAX(function(Weapon)
                    ...
                    task.spawn(function()
                        local Success, Error = pcall(LPH_NO_VIRTUALIZE(function()
                            ...
                            --[[if Config.South_Talaa._Modifications.InfiniteAmmo then
                                Module.Mag = Config.South_Talaa._Modifications.InfiniteAmmo and math.huge or OldConfig.Ammo
            
                                SetInfiniteAmmo = false
                            end
            
                            if Config.South_Talaa._Modifications.InfiniteAmmo == false and SetInfiniteAmmo == false then
                                Module.Mag = OldConfig.MaxAmmo / 2
                                SetInfiniteAmmo = true
                            end]]
            
                            --[[if Config.South_Talaa._Modifications.InfiniteClips then
                                Module.Ammo = Config.South_Talaa._Modifications.InfiniteClips and 999999 or OldConfig.MaxAmmo
            
                                SetInfiniteClips = false
                            end]]
            
                            if Config.South_Talaa._Modifications.InfiniteClips == false and SetInfiniteClips == false then
                                Module.Ammo = OldConfig.MaxAmmo
                                SetInfiniteClips = true
                            end
            
                            if ModuleSettings.LimitedAmmoEnabled then
                                ModuleSettings.LimitedAmmoEnabled = Config.South_Talaa._Modifications.InfiniteAmmo and false or OldConfig.LimitedAmmoEnabled
                            end
                            ...
                            task.spawn(function()
                                while Weapon ~= nil and LocalPlayer.Character ~= nil and Weapon.Parent == LocalPlayer.Character and Module ~= nil and ModuleSettings ~= nil and ModuleSettings.FireRate ~= nil and task.wait(.1) do
                                    if Config.South_Talaa._Modifications.DisableJamming then
                            ...
                            ModuleSettings.FireRate = Config.South_Talaa._Modifications.ModifyFireRate and GetPercentage(OldConfig.FireRate, Config.South_Talaa._Modifications.FireRateSpeed) or OldConfig.FireRate
                            
                            ModuleSettings.ReloadTime = Config.South_Talaa._Modifications.ModifyReloadSpeed and GetPercentage(OldConfig.ReloadTime, Config.South_Talaa._Modifications.ReloadSpeed) or OldConfig.ReloadTime
                            ModuleSettings.TacticalReloadTime = Config.South_Talaa._Modifications.ModifyReloadSpeed and GetPercentage(OldConfig.TacticalReloadTime, Config.South_Talaa._Modifications.ReloadSpeed) or OldConfig.TacticalReloadTime
                            
                            ModuleSettings.EquippingTime = Config.South_Talaa._Modifications.ModifyEquipSpeed and GetPercentage(OldConfig.EquippingTime, Config.South_Talaa._Modifications.EquipSpeed) or OldConfig.EquippingTime
                            
                            ModuleSettings.SpreadX = Config.South_Talaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadX, Config.South_Talaa._Modifications.SpreadPercentage) or OldConfig.SpreadX
                            ModuleSettings.SpreadY = Config.South_Talaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadY, Config.South_Talaa._Modifications.SpreadPercentage) or OldConfig.SpreadY
            
                            ModuleSettings.Recoil = Config.South_Talaa._Modifications.ModifyRecoilValue and GetPercentage(OldConfig.Recoil, Config.South_Talaa._Modifications.RecoilPercentage) or OldConfig.Recoil
            
                            ModuleSettings.ShotgunEnabled = Config.South_Talaa._Modifications.InstantKill and true or OldConfig.ShotgunEnabled
            
                            ModuleSettings.Auto = Config.South_Talaa._Modifications.Automatic or OldConfig.Auto
                        
                            ModuleSettings.JamChance = Config.South_Talaa._Modifications.DisableJamming and 0 or OldConfig.JamChance
                        end))
                ...
                local ConfigMetatable = getmetatable(Config.South_Talaa.Modifications)

                ConfigMetatable.__index = LPH_NO_VIRTUALIZE(function(...)
                    return Config.South_Talaa._Modifications[select(2, ...)]
                end)
        
                ConfigMetatable.__newindex = LPH_NO_VIRTUALIZE(function(...)
                    local Index, Value = select(2, ...)
        
                    Config.South_Talaa._Modifications[Index] = Value; ModWeapons()
                end)
                ...
                local OldMagAndAmmo; OldMagAndAmmo = hookmetamethod(game, "__namecall", LPH_NO_VIRTUALIZE(function(Self, ...)
                    ...
                    if getnamecallmethod() == "FireServer" or getnamecallmethod() == "InvokeServer" and tostring(Self) == "ChangeMagAndAmmo" and (Config.South_Talaa._Modifications.InfiniteAmmo or Config.South_Talaa._Modifications.InfiniteClips) then
                        local Arguments = {...}
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait(0.1) do
                    if not Config.South_Talaa.KillAura then continue end
                    ...
                    for Index, Value in Players:GetPlayers() do
                        if table.find(Config.South_Talaa.KillAuraWhitelist, tostring(Value)) then continue end
                        if Value == LocalPlayer then continue end
                        ...
                        if not DistanceCheck(Value, Config.South_Talaa.KillAuraRange) then continue end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do
                    ...
                    if not Config.South_Talaa.LocalPlayer_Config.Speed then continue end
                    ...
                    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                        ...
                        if Humanoid.MoveDirection.Magnitude > 0 then
                            ...
                            LocalPlayer.Character:TranslateBy(
                                Humanoid.MoveDirection * Config.South_Talaa.LocalPlayer_Config.SpeedValue 
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait() do
                    if not Config.South_Talaa.PlayerUtilities.BringingPlayer then continue end
                    if tostring(Config.South_Talaa.PlayerUtilities.SelectedPlayer) == tostring(LocalPlayer) then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") or not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart") then continue end
                    Players:FindFirstChild(Config.South_Talaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart").CFrame = LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame + Vector3.new(2, 0, 0)
                end
            end))
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do
                    task.wait(0)
                    if Config.South_Talaa.VehicleModifications.SpeedEnabled and UserInputService:IsKeyDown(Enum.KeyCode.W) then
                        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                            if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                                ...
                                if Humanoid and typeof(Humanoid) == "Instance" then
                                    ...
                                    if SeatPart and typeof(SeatPart) == "Instance" and SeatPart:IsA("VehicleSeat") then
                                        SeatPart.AssemblyLinearVelocity *= Vector3.new(1 + Config.South_Talaa.VehicleModifications.SpeedValue, 1, 1 + Config.South_Talaa.VehicleModifications.SpeedValue)
                                    end
                                end
                            end
                        end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do
                    task.wait(0)
                    if Config.South_Talaa.VehicleModifications.BreakEnabled and UserInputService:IsKeyDown(Enum.KeyCode.S) then
                        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                            if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                                local Humanoid = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                                if Humanoid and typeof(Humanoid) == "Instance" then
                                    local SeatPart = Humanoid.SeatPart
                                    if SeatPart and typeof(SeatPart) == "Instance" and SeatPart:IsA("VehicleSeat") then
                                        SeatPart.AssemblyLinearVelocity *= Vector3.new(1 - Config.South_Talaa.VehicleModifications.BreakValue, 1, 1 - Config.South_Talaa.VehicleModifications.BreakValue)
                                    end
                                end
                            end
                        end
            ...
            UserInputService.InputBegan:Connect(function(Input, GameProcessedEvent)
                if Input.KeyCode == Config.South_Talaa.VehicleModifications.InstantStopBind and Config.South_Talaa.VehicleModifications.InstantStop and (not GameProcessedEvent) then
                    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                        if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                            local Humanoid = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                            if Humanoid and typeof(Humanoid) == "Instance" then
                ...
                if Config.South_Talaa.LocalPlayer_Config.DeleteKey ~= nil and Input.UserInputType == Enum.UserInputType.MouseButton1 and UserInputService:IsKeyDown(Config.South_Talaa.LocalPlayer_Config.DeleteKey) and Config.South_Talaa.LocalPlayer_Config.DeleteOnKey and (not GameProcessedEvent) then
            ...
            ProximityPromptService.PromptButtonHoldBegan:Connect(LPH_NO_VIRTUALIZE(function(Prompt, Player)
                if Prompt and Player == LocalPlayer and fireproximityprompt then
                    if Config.South_Talaa.LocalPlayer_Config.InstantInteract then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '<font color="rgb(0,163,224)">Talaa.</font>lol\n' .. Title
            ...
            getgenv().Teleport = LPH_NO_VIRTUALIZE(function(CFrame)   
                if Config.South_Talaa.TeleportMethod == 'Dirt Bike' then
                    ...
                    return "Success"
                elseif Config.South_Talaa.TeleportMethod == 'Tween' then
                ...
                elseif Config.South_Talaa.TeleportMethod == 'Damage' then
            ...
            Start_BoxFarm = function()
                boxfarm_thread = task.spawn(LPH_NO_VIRTUALIZE(function()
                    while task.wait() do
                        ...
                        if not Config.South_Talaa.FarmingUtilities.BoxFarm then continue end
            ...
            task.spawn(LPH_JIT_MAX(function()
                while task.wait(.1) do
                    if not Config.South_Talaa.FarmingUtilities.CardFarm then continue end
            ...
            task.spawn(LPH_JIT_MAX(function()
                while task.wait(.1) do
                    if not Config.South_Talaa.FarmingUtilities.MarshmallowFarm then continue end
                    if not LocalPlayer.Character and not LocalPlayer.Character:FindFirstChild("Humanoid") then continue end
            ...
            Start_MarshmallowFarm = function()
                MarshmallowFarm_Thread = task.spawn(LPH_JIT_MAX(function()
                    while wait() do
                        if not Config.South_Talaa.FarmingUtilities.MarshmallowFarm then continue end
                        local Owns_Bike = Config.South_Talaa.OwnedBike == "No"
                        
                        local Marshmellow_Increment = Config.South_Talaa.FarmingUtilities.MarshmallowIncrement
            ...
            Start_ChipFarm = function()
                ChipFarm_Thread = task.spawn(LPH_JIT_MAX(function()
                    while task.wait(1) do
                        if not Config.South_Talaa.FarmingUtilities.ChipFarm then continue end
            ...
            Start_CardFarm = function()
                CardFarm_Thread = task.spawn(LPH_JIT_MAX(function()
                    while task.wait(1) do
                        ...
                        if Config.South_Talaa.TeleportMethod ~= "Tween" then
            ...
            Humanoid.Died:Connect(function()
                ...
                if Config.South_Talaa.FarmingUtilities.CardFarm then
                    Stop_CardFarm()
                end

                if Config.South_Talaa.FarmingUtilities.BoxFarm then
                    Stop_BoxFarm()
                end

                if Config.South_Talaa.FarmingUtilities.ChipFarm then
                    Stop_ChipFarm()
                end

                if Config.South_Talaa.FarmingUtilities.MarshmallowFarm then
            ...
            if Workspace:FindFirstChild("PromptPurchases") then
                ...
                for Index, Value in Workspace.PromptPurchases:GetChildren() do
                    ...
                    if not table.find(Config.South_Talaa.Guns, GunWithPrice) then
                        table.insert(Config.South_Talaa.Guns, GunWithPrice)

                        GunPosition[Value.Name] = Value.proxprompt.CFrame
                    end
                end

                table.sort(Config.South_Talaa.Guns)
            end
        end
        ...
        if Game_Name == "Tha Bronx 3" and RequireSupport then                                                
            local OldWeaponValues = {}
            ...
            local ModWeapon = LPH_JIT_MAX(function(Weapon)
                ...
                if Config.TheTalaa._Modifications.InfiniteClips then
                    debug.setupvalue(getsenv(Weapon:FindFirstChild("GunScript_Local")).Reload, 3, 9e17)

                    SetInfiniteClips = false
                end

                if Config.TheTalaa._Modifications.InfiniteClips == false and SetInfiniteClips == false then
                    debug.setupvalue(getsenv(Weapon:FindFirstChild("GunScript_Local")).Reload, 3, OldConfig.AmmoPerMag)

                    SetInfiniteClips = true
                end

                if Config.TheTalaa._Modifications.InfiniteAmmo then
                    debug.setupvalue(getsenv(Weapon:FindFirstChild("GunScript_Local")).Reload, 5, Config.TheTalaa._Modifications.InfiniteAmmo and 9e17 or OldConfig.AmmoPerMag / 2)
                    SetInfiniteAmmo = false
                end

                if Config.TheTalaa._Modifications.InfiniteAmmo == false and SetInfiniteAmmo == false then
                ...
                Module.FireRate = Config.TheTalaa._Modifications.ModifyFireRate and GetPercentage(OldConfig.FireRate, Config.TheTalaa._Modifications.FireRateSpeed) or OldConfig.FireRate
                            
                Module.ReloadTime = Config.TheTalaa._Modifications.ModifyReloadSpeed and GetPercentage(OldConfig.ReloadTime, Config.TheTalaa._Modifications.ReloadSpeed) or OldConfig.ReloadTime
                                
                if Module.SpreadXY then
                    Module.SpreadXY = Config.TheTalaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadXY, Config.TheTalaa._Modifications.SpreadPercentage) or OldConfig.SpreadXY
                end

                if Module.SpreadYX then
                    Module.SpreadYX = Config.TheTalaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadYX, Config.TheTalaa._Modifications.SpreadPercentage) or OldConfig.SpreadYX
                end

                if Module.Spread then
                    Module.Spread = Config.TheTalaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.Spread, Config.TheTalaa._Modifications.SpreadPercentage) or OldConfig.Spread
                end

                Module.SpreadX = Config.TheTalaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadX, Config.TheTalaa._Modifications.SpreadPercentage) or OldConfig.SpreadX
                Module.SpreadY = Config.TheTalaa._Modifications.ModifySpreadValue and GetPercentage(OldConfig.SpreadY, Config.TheTalaa._Modifications.SpreadPercentage) or OldConfig.SpreadY

                Module.Recoil = Config.TheTalaa._Modifications.ModifyRecoilValue and GetPercentage(OldConfig.Recoil, Config.TheTalaa._Modifications.RecoilPercentage) or OldConfig.Recoil

                Module.BaseDamage = Config.TheTalaa._Modifications.InfiniteDamage and math.huge or OldConfig.BaseDamage

                Module.Auto = Config.TheTalaa._Modifications.Automatic or OldConfig.Auto
            
                Module.JamChance = Config.TheTalaa._Modifications.DisableJamming and 0 or OldConfig.JamChance
    
                Module.Auto = Config.TheTalaa._Modifications.Automatic or OldConfig.Auto
        
                Module.EquipTime = Config.TheTalaa._Modifications.ModifyEquipSpeed and GetPercentage(OldConfig.EquipTime, Config.TheTalaa._Modifications.EquipSpeed) or OldConfig.EquipTime

                Module.JamChance = Config.TheTalaa._Modifications.NoJam and 0 or OldConfig.JamChance
            end)
            ...
            local ConfigMetatable = getmetatable(Config.TheTalaa.Modifications)

            ConfigMetatable.__index = LPH_NO_VIRTUALIZE(function(...)
                return Config.TheTalaa._Modifications[select(2, ...)]
            end)
    
            ConfigMetatable.__newindex = LPH_NO_VIRTUALIZE(function(...)
                local Index, Value = select(2, ...)
    
                Config.TheTalaa._Modifications[Index] = Value; ModWeapons()
            end)
        end
        ...
        if Game_Name == "Tha Bronx 3" then
            RunService.RenderStepped:Connect(LPH_NO_VIRTUALIZE(function()
                if LocalPlayer.PlayerGui:FindFirstChild("Run") and LocalPlayer.PlayerGui.Run:FindFirstChild("StaminaBarScript", true) then
                    LocalPlayer.PlayerGui.Run:FindFirstChild("StaminaBarScript", true).Disabled = Config.TheTalaa.PlayerModifications.InfiniteStamina
                end

                if LocalPlayer.PlayerGui:FindFirstChild("Hunger") and LocalPlayer.PlayerGui.Hunger:FindFirstChild("HungerBarScript", true) then
                    LocalPlayer.PlayerGui.Hunger:FindFirstChild("HungerBarScript", true).Disabled = Config.TheTalaa.PlayerModifications.InfiniteHunger
                end

                if LocalPlayer.PlayerGui:FindFirstChild("SleepGui") and LocalPlayer.PlayerGui.SleepGui:FindFirstChild("sleepScript", true) then
                    LocalPlayer.PlayerGui.SleepGui:FindFirstChild("sleepScript", true).Disabled = Config.TheTalaa.PlayerModifications.InfiniteSleep
                end

                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("CameraBobbing") then
                    LocalPlayer.Character:FindFirstChild("CameraBobbing").Disabled = Config.TheTalaa.PlayerModifications.DisableCameraBobbing
                end

                if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("FallDamageRagdoll") then
                    LocalPlayer.Character:FindFirstChild("FallDamageRagdoll").Disabled = Config.TheTalaa.PlayerModifications.NoFallDamage
                end

                if LocalPlayer.PlayerGui:FindFirstChild("BloodGui") then
                    LocalPlayer.PlayerGui:FindFirstChild("BloodGui").Enabled = not Config.TheTalaa.PlayerModifications["DisableBloodEffects"]
                end
                ...
                if LocalPlayer.PlayerGui:FindFirstChild("JumpDebounce") and LocalPlayer.PlayerGui:FindFirstChild("JumpDebounce"):FindFirstChild("LocalScript") then
                    LocalPlayer.PlayerGui:FindFirstChild("JumpDebounce").LocalScript.Disabled = Config.TheTalaa.PlayerModifications.NoJumpCooldown
                end
                ...
                if LocalPlayer.PlayerGui:FindFirstChild("CameraTexts") and LocalPlayer.PlayerGui:FindFirstChild("CameraTexts"):FindFirstChild("LocalScript") then
                    LocalPlayer.PlayerGui:FindFirstChild("CameraTexts").Enabled = not Config.TheTalaa.PlayerModifications.DisableCameras
                    LocalPlayer.PlayerGui:FindFirstChild("CameraTexts").LocalScript.Disabled = Config.TheTalaa.PlayerModifications.DisableCameras
                end
                ...
                if LocalPlayer.PlayerGui:FindFirstChild("RentGui") and LocalPlayer.PlayerGui:FindFirstChild("RentGui"):FindFirstChild("LocalScript") then
                    LocalPlayer.PlayerGui:FindFirstChild("RentGui").LocalScript.Disabled = Config.TheTalaa.PlayerModifications.NoRentPay
                end

                if Config.TheTalaa.PlayerModifications.AutoPickupBags and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
                ...
                if Config.TheTalaa.PlayerModifications.AutoPickupCash and LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            LocalPlayer.CharacterAdded:Connect(LPH_NO_VIRTUALIZE(function()
                if Config.TheTalaa.PlayerModifications.DisableCameras then
            ...
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                ...
                LocalPlayer.Character.DescendantAdded:Connect(function(Descendant)
                    if Descendant:IsA("BodyVelocity") or Descendant:IsA("LinearVelocity") or Descendant:IsA("VectorForce") and Config.TheTalaa.PlayerModifications.NoKnockback then
            ...
            LocalPlayer.CharacterAdded:Connect(LPH_NO_VIRTUALIZE(function(Character)
                ...
                if Config.TheTalaa.PlayerModifications.RespawnWhereYouDied and typeof(DeathFrame) == "CFrame" then
            ...
            local OnCharacter = LPH_NO_VIRTUALIZE(function(character: Model)
                ...
                if Config.TheTalaa.Fly.Enabled then
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait(1) do
                    if not Config.TheTalaa.KillAura then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChildOfClass("Tool") or not LocalPlayer.Character:FindFirstChildOfClass("Tool"):FindFirstChild("Setting") then continue end
                    for Index, Value in Players:GetPlayers() do
                        ...
                        if not DistanceCheck(Value, Config.TheTalaa.KillAuraRange) then continue end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait() do
                    if not Config.TheTalaa.PlayerUtilities.BugPlayer then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart") then continue end                    
                    ...
                    Car_To_Use:SetPrimaryPartCFrame(Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart").CFrame)
                end
            end))

            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait(.25) do
                    if not Config.TheTalaa.AutoDrop then continue end
                    ReplicatedStorage:WaitForChild("BankProcessRemote"):InvokeServer("Drop", tostring(Config.TheTalaa.MoneyAmount))
                end
            end))

            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait(1) do
                    if not Config.TheTalaa.PlayerUtilities.AutoKill then continue end
                    if not LocalPlayer.Character then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart") then continue end                    
                    ...
                    if Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid").Health == 0 then continue end
                    if Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChildOfClass("ForceField") then continue end

                    if RequireSupport then
                        kill_gun(Config.TheTalaa.PlayerUtilities.SelectedPlayer, 'Head', math.huge)
                    else
                        if DistanceCheck(Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer), 300) == false then
                            local OldCFrame = LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame
                            Teleport(Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart").CFrame)
                            kill_gun(Config.TheTalaa.PlayerUtilities.SelectedPlayer, 'Head', math.huge)
                            task.wait(.5)
                            Teleport(OldCFrame)
                        else
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait(2) do
                    if not Config.TheTalaa.PlayerUtilities.AutoRagdoll then continue end
                    if not LocalPlayer.Character then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart") then continue end                    
                    if not LocalPlayer.Character:FindFirstChildOfClass("Tool") then continue end
                    if not LocalPlayer.Character:FindFirstChildOfClass("Tool"):FindFirstChild("GunScript_Local") then continue end
                    ...
                    if Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid").Health == 0 then continue end
                    if Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("Humanoid"):GetState() == Enum.HumanoidStateType.Physics then continue end

                    kill_gun(Config.TheTalaa.PlayerUtilities.SelectedPlayer, 'RightUpperLeg', 0.01)
                end
            end))

            task.spawn(LPH_NO_VIRTUALIZE(function()
                while task.wait() do
                    if not Config.TheTalaa.PlayerUtilities.BringingPlayer then continue end
                    if tostring(Config.TheTalaa.PlayerUtilities.SelectedPlayer) == tostring(LocalPlayer) then continue end
                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer) or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character or not Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart") then continue end
                    Players:FindFirstChild(Config.TheTalaa.PlayerUtilities.SelectedPlayer).Character:FindFirstChild("HumanoidRootPart").CFrame = LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame + Vector3.new(2, 0, 0)
                end
            end))
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do
                    task.wait(0)
                    if Config.TheTalaa.VehicleModifications.SpeedEnabled and UserInputService:IsKeyDown(Enum.KeyCode.W) then
                        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                            if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                                local Humanoid = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                                if Humanoid and typeof(Humanoid) == "Instance" then
                                    local SeatPart = Humanoid.SeatPart
                                    if SeatPart and typeof(SeatPart) == "Instance" and SeatPart:IsA("VehicleSeat") then
                                        SeatPart.AssemblyLinearVelocity *= Vector3.new(1 + Config.TheTalaa.VehicleModifications.SpeedValue, 1, 1 + Config.TheTalaa.VehicleModifications.SpeedValue)
                                    end
                                end
                            end
                        end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do
                    task.wait(0)
                    if Config.TheTalaa.VehicleModifications.BreakEnabled and UserInputService:IsKeyDown(Enum.KeyCode.S) then
                        if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                            if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                                local Humanoid = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                                if Humanoid and typeof(Humanoid) == "Instance" then
                                    local SeatPart = Humanoid.SeatPart
                                    if SeatPart and typeof(SeatPart) == "Instance" and SeatPart:IsA("VehicleSeat") then
                                        SeatPart.AssemblyLinearVelocity *= Vector3.new(1 - Config.TheTalaa.VehicleModifications.BreakValue, 1, 1 - Config.TheTalaa.VehicleModifications.BreakValue)
                                    end
                                end
                            end
                        end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do task.wait()
                    if not Config.TheTalaa.Farms.FarmConstructionJob then continue end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do task.wait()
                    if not Config.TheTalaa.Farms.FarmBank then continue end
                    ...
                    if not Robbable then
                        if Config.TheTalaa.Farms.AFKCheck then
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do task.wait()
                    if not Config.TheTalaa.Farms.FarmHouses then continue end
                    ...
                    if not HardDoorEnabled and Config.TheTalaa.Farms.AFKCheck then
                        Teleport(SafePosition)
                        continue
                    end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do task.wait()
                    if not Config.TheTalaa.Farms.FarmStudio then continue end
            ...
            task.spawn(LPH_NO_VIRTUALIZE(function()
                while true do task.wait()
                    if not Config.TheTalaa.Farms.FarmTrash then continue end

                    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then continue end
                    if not LocalPlayer.Character:FindFirstChild("Humanoid") or LocalPlayer.Character:FindFirstChild("Humanoid").Health == 0 then continue end

                    for Index, Value in Workspace:GetChildren() do
                        if Value.Name == "DumpsterPromt" and Config.TheTalaa.Farms.FarmTrash then
                    ...
                    if Config.TheTalaa.Farms.AutoSellTrash then
                        for Index, Value in LocalPlayer.Backpack:GetChildren() do
            ...
            UserInputService.InputBegan:Connect(function(Input, GameProcessedEvent)
                if Input.KeyCode == Config.TheTalaa.VehicleModifications.InstantStopBind and Config.TheTalaa.VehicleModifications.InstantStop and (not GameProcessedEvent) then
                    if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then
                        if LocalPlayer.Character and typeof(LocalPlayer.Character) == "Instance" then
                            local Humanoid = LocalPlayer.Character:FindFirstChildWhichIsA("Humanoid")
                            if Humanoid and typeof(Humanoid) == "Instance" then
            ...
            CollectDroppedMoney = LPH_NO_VIRTUALIZE(function()  
                if not Config.TheTalaa.Farms.CollectDroppedMoney then return end
            ...
            CollectLootBags = LPH_NO_VIRTUALIZE(function()  
                if not Config.TheTalaa.Farms.CollectDroppedLoot then return end
                if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then return end
                local OldCFrame = LocalPlayer.Character.HumanoidRootPart.CFrame
                ...
                for Index, Value in next, {Workspace.Storage:GetChildren()} do
                    for _Index, _Value in Value do
                        ...
                        --[[if Config.TheTalaa.Farms.OnlyCollectGuns then
            ...
            RunService.PreRender:Connect(LPH_NO_VIRTUALIZE(function()
                if not Config.TheTalaa.PlayerModifications.InstantRevive then return end
                if not LocalPlayer.Character then return end
                if not LocalPlayer.Character:FindFirstChild("Humanoid") then return end
            ...
            ProximityPromptService.PromptButtonHoldBegan:Connect(function(Prompt, Self)
                if Prompt and Self == LocalPlayer and fireproximityprompt then
                    if Config.TheTalaa.PlayerModifications.InstantInteract then
                        fireproximityprompt(Prompt, true)
                    end

                    if Config.TheTalaa.PlayerModifications.BypassLockedCars then
            ...
            UserInputService.InputBegan:Connect(LPH_NO_VIRTUALIZE(function(Input, Game_Event)
                ...
                if Game_Event then return end
                if Input.UserInputType == Enum.UserInputType.MouseButton1 and library.flags["ClickTeleport_TheTalaa"] and Config.TheTalaa.ClickTeleportActive then
                    local MouseLocation = UserInputService:GetMouseLocation()
...
local window = library:window({name = "Talaa", suffix = ".lol", gameInfo = string.format("Talaa.lol : %s", Game_Name:lower())})
    ...
    window:seperator({name = "Game"}) do
        local LocalPlayerTab, PlayersTab, PurchaseGunTab, MiscTab, SafeTab = window:tab({name = "Main", tabs = {"Local Player", "Players", "Teleports", "Misc", "Safe"}, icon = GetImage("World.png")}) do
            do -- \\ Safe Tab
                ...
                local _SafeItem = SafeItemSection:list({flag = "SafeSelectedItem_TheTalaa", options = {}, callback = function(state)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not state then
                            return
                        end
                ...
                local _TakeItem = SafeItemSection:list({flag = "TakeSelectedItem_TheTalaa", options = {}, callback = function(state)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not state then
                            return
                        end
            ...
            do -- \\ Local Player Tab
                ...
                for _, Index in __Modifications do
                    LocalPlayerModsSection:toggle({type = "toggle", name = Index, flag = Index, default = false, callback = function(state)
                        Config.TheTalaa.PlayerModifications[Index:gsub(" ", "")] = state
                    end})
                end
                ...
                CharacterModsSection:toggle({type = "toggle", name = "Modify WalkSpeed", flag = "ModifyWalkSpeed_TheTalaa", default = false, callback = function(state)
                    Config.MiscSettings.ModifySpeed.Enabled = state
                end})

                CharacterModsSection:toggle({type = "toggle", name = "Modify JumpPower", flag = "ModifyJumpPower_TheTalaa", default = false, callback = function(state)
                    Config.MiscSettings.ModifyJump.Enabled = state
                end})

                CharacterModsSection:toggle({type = "toggle", name = "Click Teleport", flag = "ClickTeleport_TheTalaa", default = false})

                local _NoClipToggle = CharacterModsSection:toggle({type = "toggle", name = "No Clip", flag = "NoClip_TheTalaa", seperator = true, default = false, callback = function(state)
                    if state then
                ...
                CharacterModsSection:slider({name = "WalkSpeed Value", flag = "WalkSpeedValue_TheTalaa", min = 0, max = 250, default = 50, suffix = "%", callback = function(state)
                    Config.MiscSettings.ModifySpeed.Value = state
                end})

                CharacterModsSection:slider({name = "JumpPower Value", flag = "JumpPowerValue_TheTalaa", min = 0, max = 250, default = 7, suffix = "%", callback = function(state)
                    Config.MiscSettings.ModifyJump.Value = state
                end})

                CharacterModsSection:keybind({name = "Click Teleport Key", flag = "ClickTeleportKey_TheTalaa", key = Enum.KeyCode.LeftControl, mode = "Hold", callback = function(state)
                    Config.TheTalaa.ClickTeleportActive = state
                end})
                ...
                local _UINames, BlacklistedNames = {'ATM GUI'}, {"Dead", "Settings1", "Controls", "FirstShopGUI", "Freecam", "ThaShop2", "WATCH GUI", "NYPD Cars", "CONSTRUCTION LEVEL", "RobPlayerUI", "Talaa LOCKER", 'MobileBeam', 'Settings', 'Flash', 'Enter', 'CopSirens'}
                ...
                UISection:dropdown({name = "Selected UI", flag = "SelectedUI_TB3", width = 120, items = _UINames, seperator = false, multi = false, default = 'Talaa Market 2'})
            ...
            do -- \\ Players Tab
                ...
                local PlayerList = PlayerListSection:list({flag = "SelectPlayer_TheTalaa", options = {}, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.SelectedPlayer = tostring(state)
                end})
                ...
                PlayerOptionsSection:toggle({type = "toggle", name = "Spectate Player", flag = "SpectatePlayer_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.SpectatePlayer = state
                end})

                PlayerOptionsSection:toggle({type = "toggle", name = "Bring Player", flag = "BringPlayer_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.BringingPlayer = state
                end})

                PlayerOptionsSection:toggle({type = "toggle", name = "Bug / Kill Player - Car", flag = "BugPlayer_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.BugPlayer = state
                end})

                PlayerOptionsSection:toggle({type = "toggle", name = "Auto Kill Player - Gun", flag = "AutoKillPlayer_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.AutoKill = state
                end})

                PlayerOptionsSection:toggle({type = "toggle", name = "Auto Ragdoll Player - Gun", flag = "AutoRagdollPlayer_TheTalaa", seperator = true, default = false, callback = function(state)
                    Config.TheTalaa.PlayerUtilities.AutoRagdoll = state
                end})

                PlayerOptionsSection:button({name = "Teleport To Player", callback = function()
                    task.spawn(Teleport, Players[Config.TheTalaa.PlayerUtilities.SelectedPlayer].Character.HumanoidRootPart.CFrame)
                end})

                PlayerOptionsSection:button({name = "Down Player - Hold Gun", callback = function(state)
                    pcall(kill_gun, Config.TheTalaa.PlayerUtilities.SelectedPlayer, "HumanoidRootPart", (Players[Config.TheTalaa.PlayerUtilities.SelectedPlayer].Character.Humanoid.Health - 5))
                end})

                PlayerOptionsSection:button({name = "Kill Player - Hold Gun", callback = function(state)
                    pcall(kill_gun, Config.TheTalaa.PlayerUtilities.SelectedPlayer, "HumanoidRootPart", math.huge)
                end})

                PlayerOptionsSection:button({name = "God Player - Hold Gun", callback = function(state)
                    pcall(kill_gun, Config.TheTalaa.PlayerUtilities.SelectedPlayer, "HumanoidRootPart", math.sqrt(-1))
                end})

                PlayerOptionsSection:button({name = "Fling Player - Hold Gun", callback = function(state)
                    for Index=1, 50 do
                        pcall(kill_gun, Config.TheTalaa.PlayerUtilities.SelectedPlayer, "RightUpperLeg", 0.01)
                    end
                end})
            ...
            do -- \\ Misc Tab
                ...
                FarmingSection:toggle({type = "toggle", name = "Auto Farm Construction", flag = "FarmConstruction_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.FarmConstructionJob = state
                end})

                FarmingSection:toggle({type = "toggle", name = "Auto Farm Bank Robbery", flag = "FarmBank_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.FarmBank = state
                end})

                FarmingSection:toggle({type = "toggle", name = "Auto Farm House Robbery", flag = "FarmHouses_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.FarmHouses = state
                end})

                FarmingSection:toggle({type = "toggle", name = "Auto Farm Studio Robbery", flag = "FarmStudio_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.FarmStudio = state
                end})

                FarmingSection:toggle({type = "toggle", name = "Auto Farm Dumpsters", flag = "FarmDumpsters_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.FarmTrash = state
                end})

                local ManualFarmSections = Column:section({name = "Manual Farms", size = 0.325, default = false, side = 'left', icon = GetImage("Pickkaxe.png")}) 

                ManualFarmSections:toggle({type = "toggle", name = "Auto Collect Dropped Cash", flag = "FarmDroppedMoney_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.CollectDroppedMoney = state
                end})

                ManualFarmSections:toggle({type = "toggle", name = "Auto Collect Dropped Bags", flag = "FarmDroppedLoot_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.CollectDroppedLoot = state
                end})
                ...
                FarmSettingsSection:toggle({type = "toggle", name = "AFK Safety Teleport", flag = "AFKCheck_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.AFKCheck = state
                end})

                FarmSettingsSection:toggle({type = "toggle", name = "Auto Sell Trash", flag = "SellTrash_TheTalaa", default = false, callback = function(state)
                    Config.TheTalaa.Farms.AutoSellTrash = state
                end})
                ...
                KillAuraSection:toggle({name = "Enabled - Hold Gun", flag = "KillAura_Enabled_TB3", type = "toggle", default = false, callback = function(state)
                    Config.TheTalaa.KillAura = state
                end})
                ...
                KillAuraSection:slider({name = "Kill Aura Range", flag = "KillAuraRange_TB3", min = 0, max = 1000, default = 300, suffix = "st", callback = function(state)
                    Config.TheTalaa.KillAuraRange = state
                end})
            end
            ...
            do -- \\ Purchase Guns
                ...
                WeaponListSection:list({flag = "PurchaseSelectedItem_TheTalaa", options = Config.Guns, callback = function(state)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not state then
                            return
                        end

                        Config.TheTalaa.Selected_Item = state

                        local self = string.match(Config.TheTalaa.Selected_Item, "^(.*) %-");
                ...
                for Index, Value in Config.TheTalaa.TeleportationList do
                    table.insert(List, Index)
                end

                table.sort(List)

                TeleportListSection:list({flag = "TeleportToPlace_TheTalaa", options = List, callback = function(state)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not state then
                            return
                        end

                        Teleport(Config.TheTalaa.TeleportationList[state])
    ...
    window:seperator({name = "Game"}) do
        local LocalPlayerTab, PlayersTab, PurchaseGunTab = window:tab({name = "Main", tabs = {"Local Player", "Players", "Teleports"}, icon = GetImage("World.png")}) do
            do -- \\ Local Player
                ...
                for _, Index in __Modifications do
                    LocalPlayerModsSection:toggle({type = "toggle", name = Index, flag = Index.."_SB", default = false, callback = Index ~= "No Clip" and LPH_NO_VIRTUALIZE(function(Value)
                            ...
                            Config.South_Talaa.LocalPlayer_Config[Index] = Value
                ...
                LocalPlayerModsSection:slider({name = "WalkSpeed Value", flag = "WalkSpeedValue_SouthTalaa", min = 0, max = 50, default = 25, suffix = "%", callback = function(state)
                    Config.South_Talaa.LocalPlayer_Config.SpeedValue = state/100
                end})

                LocalPlayerModsSection:keybind({name = "Delete + Click Key", flag = "DeleteOnKey_SouthTalaa", key = Enum.KeyCode.LeftControl, mode = "Hold", callback = function(state)
                    Config.South_Talaa.LocalPlayer_Config.DeleteKey = library.flags["DeleteOnKey_SouthTalaa"].key
                end})
                ...
                TeleportMethodSection:dropdown({name = "Select Method", flag = "TeleportMethod_SB", width = 100, items = {"Dirt Bike", "Damage", "Tween"}, seperator = false, multi = false, default = "Damage", callback = function(state)
                    Config.South_Talaa.TeleportMethod = state
                end})
                ...
                FarmSection:toggle({name = "Auto-Farm Cards", default = false, flag = "Card_Auto_Farm", type = "toggle", callback = function(state)
                    task.spawn(function() if not _ScriptLoaded then return end
                        if Config.South_Talaa.OwnedBike == "Unknown" then
                            local Bike = Find_Bike()
                            if Bike == nil then
                                ReplicatedStorage:WaitForChild("RemoteEvents"):WaitForChild("Dealershipinteraction"):FireServer("Spawn", "DirtBike")
                                task.wait(1)
                                Bike = Find_Bike()
                                task.wait(1)
                                if Bike == nil then Config.South_Talaa.OwnedBike = "No" else Config.South_Talaa.OwnedBike = "Yes" end
                            else
                                Config.South_Talaa.OwnedBike = "Yes"
                            end
                            task.wait(0.5)
                        end
                        Config.South_Talaa.FarmingUtilities.CardFarm = state
                ...
                FarmSection:toggle({name = "Auto-Farm Boxes", default = false, flag = "Box_Auto_Farm", type = "toggle", callback = function(state)
                    if not _ScriptLoaded then return end
                    Config.South_Talaa.FarmingUtilities.BoxFarm = state
                ...
                FarmSection:toggle({name = "Auto-Farm Chips", default = false, flag = "Chip_Auto_Farm", type = "toggle", callback = function(state)
                    task.spawn(function() if not _ScriptLoaded then return end
                        ...
                        Config.South_Talaa.FarmingUtilities.ChipFarm = state
                ...
                FarmSection:toggle({name = "Auto-Farm Marshmallows", default = false, flag = "Marshmallow_Auto_Farm", type = "toggle", callback = function(state)
                    task.spawn(function() if not _ScriptLoaded then return end
                        ...
                        Config.South_Talaa.FarmingUtilities.MarshmallowFarm = state
                ...
                _MarshMallowDropdown = FarmSection:slider({name = "Marshmallow Amount - $950", flag = "Marshmallow_Amount", min = 1, max = 50, default = 5, suffix = "", callback = function(state)
                    Config.South_Talaa.FarmingUtilities.MarshmallowIncrement = state
            ...
            do -- \\ Teleports
                ...
                for Index, Value in Config.South_Talaa.Locations do
                ...
                WeaponListSection:list({flag = "PurchaseSelectedItem_SouthTalaa", options = Config.South_Talaa.Guns, callback = function(v)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not v then return end

                        Config.South_Talaa.Selected_Item = tostring(v)

                        local self = string.match(Config.South_Talaa.Selected_Item, "^(.*) %-");
                        ...
                        local suc, err = pcall(function()
                            ...
                            for Index = 1, Config.South_Talaa.Item_Amount do
                ...
                TeleportListSection:list({flag = "TeleportToPlace_SouthTalaa", options = Location_Names, callback = function(state)
                    task.spawn(LPH_NO_VIRTUALIZE(function()
                        if not state then
                            return
                        end
                        ...
                        Config.South_Talaa.Selected_Location = state
                        ...
                        local suc, error = pcall(function()
                            if Config.South_Talaa.Selected_Location ~= "Dirty Hobo 💩" and Config.South_Talaa.Selected_Location ~= "Active ATM 🏧" then
                            _Position = Config.South_Talaa.Locations[Config.South_Talaa.Selected_Location]
                            Teleport(Config.South_Talaa.Locations[Config.South_Talaa.Selected_Location])
                            elseif Config.South_Talaa.Selected_Location == "Dirty Hobo 💩" then
                            ...
                            elseif Config.South_Talaa.Selected_Location == "Active ATM 🏧" then
                                local ATMPositions = {
                                    ATM1 = CFrame.new(-30, 4, -300);
                                    ATM2 = CFrame.new(539, 4, -353);
                                    ATM3 = CFrame.new(497, 4, 403);
            ...
            do -- \\ Player Tab        
                ...
                local PlayerList = PlayerListSection:list({flag = "SelectPlayer_SouthTalaa", options = {}, callback = function(state)
                    Config.South_Talaa.PlayerUtilities.SelectedPlayer = tostring(state)
                end})
                ...
                PlayerOptionsSection:toggle({type = "toggle", name = "Spectate Player", flag = "SpectatePlayer_SouthTalaa", default = false, callback = function(state)
                    Config.South_Talaa.PlayerUtilities.SpectatePlayer = state
                end})

                PlayerOptionsSection:toggle({type = "toggle", name = "Bring Player", flag = "BringPlayer_SouthTalaa", default = false, callback = function(state)
                    Config.South_Talaa.PlayerUtilities.BringingPlayer = state
                end})

                PlayerOptionsSection:button({name = "Teleport To Player", callback = function()
                    task.spawn(function()
                        if not Config.South_Talaa.PlayerUtilities.SelectedPlayer then return end

                        local Success, Error = pcall(function()
                            Teleport(Players[Config.South_Talaa.PlayerUtilities.SelectedPlayer].Character.HumanoidRootPart.CFrame)
                        end)

                        if (LocalPlayer.Character.HumanoidRootPart.Position - Players[Config.South_Talaa.PlayerUtilities.SelectedPlayer].Character.HumanoidRootPart.Position).Magnitude > 20 then
                            library.notifications:create_notification({
                                name = "Talaa.lol",
                                info = `Failed to teleport to {Config.South_Talaa.PlayerUtilities.SelectedPlayer}!`,
                                lifetime = 7.5
                            })
                        ...
                        if Success then
                            library.notifications:create_notification({
                                name = "Talaa.lol",
                                info = `Successfully teleported to {Config.South_Talaa.PlayerUtilities.SelectedPlayer}!`,
                                lifetime = 7.5
                            })
                        else
                            library.notifications:create_notification({
                                name = "Talaa.lol",
                                info = `Failed to teleport to {Config.South_Talaa.PlayerUtilities.SelectedPlayer}. Error : {Error}`,
                                lifetime = 10
                            })
                        end
                    end)
                ...
                PlayerOptionsSection:button({name = "Get Into Players Car", callback = function()
                    pcall(SitInPlayersVehicle, Players[Config.South_Talaa.PlayerUtilities.SelectedPlayer])
                end})
            end
        end
    end
...
window:seperator({name = "Combat"}) do
    local SilentAimTab = window:tab({name = "Silent Aim", tabs = {"General Settings"}, icon = GetImage("Pistol.png")}) do
        ...
        SettingsSection:slider({name = "Max Distance", flag = "MaxDistance_Silent", min = 0, max = (Game_Name == "South Talaa") and 300 or 3000, default = (Game_Name == "South Talaa") and 300 or 1000, suffix = "st", callback = function(state)
    ...
    local AimlockTab = window:tab({name = "Aimlock", tabs = {"General Settings"}, icon = GetImage("Aimlock.png")}) do
        ...
        SettingsSection:slider({name = "Max Distance", flag = "MaxDistance_Aimlock", min = 0, max = 3000, default = ((Game_Name == "South Talaa") and 300 or 1000), suffix = "st", callback = function(state)
    ...
    if Game_Name == "Tha Bronx 3" and not Solara then
            ...
            local WeaponModTabColumn = WeaponModTab:column({}) do
                ...
                for _, Index in Modifications do
                    GeneralSection:toggle({name = Index, flag = Index.."_TB3", type = "toggle", default = false, callback = function(state)
                        ...
                        Config.TheTalaa.Modifications[Index:gsub(" ", "")] = state
                    end})
                end
                ...
                GeneralSection:slider({name = "Recoil Percentage", flag = "RecoilValue_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.TheTalaa.Modifications.RecoilPercentage = state
                end})
                ...
                GeneralSection:slider({name = "Spread Percentage", flag = "SpreadValue_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.TheTalaa.Modifications.SpreadPercentage = state
                end})
                ...
                GeneralSection:slider({name = "Fire Rate Percentage", flag = "FireRateSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.TheTalaa.Modifications.FireRateSpeed = state
                end})
                ...
                GeneralSection:slider({name = "Reload Speed Percentage", flag = "ReloadSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.TheTalaa.Modifications.ReloadSpeed = state
                end})
                ...
                GeneralSection:slider({name = "Equip Speed Percentage", flag = "EquipSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.TheTalaa.Modifications.EquipSpeed = state
                end})
            end
        ...
        local WeaponModTab = window:tab({name = "Modifications", tabs = {"Weapon Modifications"}, icon = GetImage("Wrench.png")}) do
            local WeaponModTabColumn = WeaponModTab:column({}) do
                ...
                for _, Index in Modifications do
                    GeneralSection:toggle({name = Index, flag = Index.."_TB3", type = "toggle", default = false, callback = function(state)
                        if Index == "Fully Automatic" then Index = "Automatic" end
                        Config.South_Talaa.Modifications[Index:gsub(" ", "")] = state
                    end})
                end
                ...
                GeneralSection:slider({name = "Recoil Percentage", flag = "RecoilValue_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.South_Talaa.Modifications.RecoilPercentage = state
                end})

                GeneralSection:slider({name = "Spread Percentage", flag = "SpreadValue_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.South_Talaa.Modifications.SpreadPercentage = state
                end})

                GeneralSection:slider({name = "Fire Rate Percentage", flag = "FireRateSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.South_Talaa.Modifications.FireRateSpeed = state
                end})

                GeneralSection:slider({name = "Reload Speed Percentage", flag = "ReloadSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.South_Talaa.Modifications.ReloadSpeed = state
                end})

                GeneralSection:slider({name = "Equip Speed Percentage", flag = "EquipSpeed_TB3", default = 50, min = 0, max = 100, suffix = "%", callback = function(state)
                    Config.South_Talaa.Modifications.EquipSpeed = state
                end})
            end
        end
    end
...
if Game_Name == "South Talaa" then
    local DupeTab = window:tab({name = "Duplication", tabs = {"General"}, icon = GetImage("Cash.png")}) do
        ...
        DuplicationSection:textbox({name = "Selected Player's Name", callback = function(text)
            ...
            writefile("SouthTalaaUsernameRealGame.txt", name)
        end})

        DuplicationSection:textbox({name = "Amount To Send (Max Is $20000)", callback = function(text)
            writefile("SouthTalaaAmountRealGame.txt", text)
        end})
...
if hookfunction and not Solara and LPH_OBFUSCATED and Game_Name == "South Talaa" then
    local _FireServer;
    local _Function;
